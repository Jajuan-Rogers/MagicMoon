...
const.HAND_CARD_OFFSET_X = const.HAND_CARD_ORIGIN_X + (const.HAND_CARD_WIDTH * 0.75)
const.HAND_CARD_OFFSET_Y = const.HAND_CARD_ORIGIN_Y + (const.HAND_CARD_WIDTH * 0.75)
...
---game board pos
local gb_x = math.ceil(const.SCREEN_WIDTH / 4)
